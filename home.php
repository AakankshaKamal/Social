...
// $getFromU->update('users',$user_id,array('username'=>'mehan'));
...
{
	$error="Text length exceeds 140 characters...check";
...
<script src="<?php echo BASE_URL.('assets/js/hashtag.js'); ?>"></script><!---Inner wrapper-->
