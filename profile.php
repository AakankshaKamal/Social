...
<?php if($getFromU->loggedIN()===true){?>
			...
			<?php }else{
echo '<li><a href="'.BASE_URL.'includes/index.php">Have an account? LOgged in">
</a></li>';
			}?>
			</ul>
		</div><!-- nav right ends-->
...
<?php if(! empty($profileData->website)){?>
			<li>
				...
				<div class="profile-ex-location">
					<a href="<?php echo BASE_URL.$profileData->website ; ?>" target="_blank"><?php echo BASE_URL.$profileData->website ; ?>"</a>
				</div>
			</li>
<?php } ?>
			<li>
